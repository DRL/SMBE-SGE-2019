...
\tikzset{pop0/.style={red!70},pop1/.style={blue!70}}
...
% Populations
\foreach \x in {0,1} \fill[pop\x] ($(leftAx) + (pop\x)$) -- ++(0,5) -- ++(2, 0) -- ++(0, -5) -- cycle;
\foreach \x in {0,1} \node[above,pop\x] (label\x) at ($(leftAx) + (pop\x) + (1, 5)$) {Population \x};
\fill[white] ($(leftAx) + (pop1) + (0,4.15)$) -- ++(2,0) -- ++(0,.85) -- ++(-2,0) -- cycle;

% Migrations
\foreach \y in {0,1,2,3} \draw[pop0,dashed,->,very thick] ($(.1,.1) + (leftAx) + (0,\y + .5)+(pop0) + (popwidth)$) -- +(2.3,0);
\foreach \y in {0,1,2,3} \draw[pop1,dashed,->,very thick] ($(-.1,-.1) + (leftAx) + (0,\y + .5)+(pop1)$) -- +(-2.3,0);
\draw[pop0,->,line width=2mm] ($(.1,0) + (leftAx) + (0,4)+(pop0) + (popwidth)$) -- +(2.3,0);

% Times
\draw[densely dashed,color=gray] (8,0) node[below left] {\tiny Present day} -- (-1,0);
