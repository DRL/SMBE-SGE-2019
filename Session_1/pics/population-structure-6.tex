...
\fill[white] ($(leftAx) + (pop0) + (-.1,1)$) -- ++ (0,2) -- ++ (0.5, 0) -- ++(0,-2) -- cycle;
\fill[white] ($(leftAx) + (pop0) + (1.5,0) + (.1,1)$) -- ++ (0,2) -- ++ (0.5, 0) -- ++(0,-2) -- cycle;
\fill[pop1] ($(leftAx) + (pop1) + (.5,0)$) -- ++(0,5) -- ++(1,0) -- ++(0,-5) -- cycle;
\fill[pop1] ($(leftAx) + (pop1) $) to[out=55,in=90] ++(.51,2) -- ++(0,-2) -- cycle;
\fill[pop1] ($(leftAx) + (pop1) + (popwidth)$) to[out=125,in=90] ++(-.51,2) -- ++(0,-2) -- cycle;
